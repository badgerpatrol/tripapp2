...
export default function SettlementPlanSection({
  ...
  return (
    <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6 md:p-8 mb-6">
      {/* Header with Reopen Spending button */}
      ...
      {!loading && !error && balanceData && (
        <div className="space-y-6">
          ...
          {/* Toggle to View Spends Button */}
          <div className="pt-4 border-t border-zinc-200 dark:border-zinc-700">
            <button
              onClick={onToggleSpends}
              className="w-full tap-target px-4 py-3 rounded-lg bg-zinc-100 dark:bg-zinc-700 hover:bg-zinc-200 dark:hover:bg-zinc-600 text-zinc-900 dark:text-zinc-100 font-medium transition-colors flex items-center justify-center gap-2"
            >
