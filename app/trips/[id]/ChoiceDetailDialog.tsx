          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex gap-2">
              {canManage && onManage && (
                <button
                  onClick={onManage}
                  className="tap-target px-3 py-1.5 rounded-lg bg-zinc-100 dark:bg-zinc-700 hover:bg-zinc-200 dark:hover:bg-zinc-600 text-zinc-700 dark:text-zinc-300 font-medium transition-colors text-xs sm:text-sm whitespace-nowrap"
                >
                  Edit
                </button>
              )}
