...
export default function MenuUrlSheet({
  tripId,
  choiceId,
  tripCurrency,
  isOpen,
  ...
  const parseMenuFromUrl = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/ai/menu-parse-url", {
        method: "POST",
        headers: {
        ...
        <div className="p-6 md:p-8">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1">
                {scannedItems
                  ...
                  : "Enter the URL of a restaurant menu page"}
              </p>
            </div>
            <button
              onClick={handleClose}
          ...
          {!scannedItems && (
            <div className="space-y-4">
              <div>
                <label htmlFor="menu-url" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">
                  Menu URL
                </label>
                <input
                  id="menu-url"
                ...
                <p className="mt-2 text-xs text-zinc-500 dark:text-zinc-400">
                  Enter the full URL of the restaurant's menu page (e.g., https://restaurant.com/menu)
                </p>
              </div>
