    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900 overflow-x-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} id="edit-kit-form" className="space-y-8">
          {/* Error */}
          {error && (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex gap-3">
            <Button
              ...
              className="flex-1 text-xs sm:text-sm px-2 sm:px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white flex items-center justify-center"
            ...
            <Button
              type="button"
              onClick={() => router.push(returnTo)}
              className="flex-1 text-xs sm:text-sm px-2 sm:px-4 py-2.5 bg-zinc-200 hover:bg-zinc-300 text-zinc-700 dark:bg-zinc-600 dark:hover:bg-zinc-500 dark:text-zinc-200 flex items-center justify-center"
              disabled={saving}
            >
              Cancel
            </Button>
            <Button
              type="submit"
              form="edit-kit-form"
              className="flex-1 text-xs sm:text-sm px-2 sm:px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center"
              disabled={saving}
            >
              {saving ? "Saving..." : "Save"}
            </Button>
          ...
          <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-xl max-w-md w-full p-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-zinc-600 dark:text-zinc-400">
                  Are you sure you want to delete "{items.find(i => i.id === itemToDelete)?.label || 'this item'}"?
                </p>
              </div>
            </div>
